...
function ContainerList({container, deleteContainer, editContainer }) {
  return (
    <tr key={container.id}>
    ...
    font-bold py-2 px-4 border-b-4 border-blue-700" onClick={(e, id) => editContainer(e, container.id)}> 
    <i className="bi bi-pencil-square">Edit</i>  </button> </th>
    <th className="text-right"> <button className="bg-blue-500 text-white 
    font-bold py-2 px-4 border-b-4 border-blue-700" onClick={(e, id) => deleteContainer(e, container.id)}> 
